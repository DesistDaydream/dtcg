...
nerdctl build . -t lchdzh/dtcg:v1.8.6 -f build/dtcg/Dockerfile
...
nerdctl run -it --rm --name dtcg --network host -v ~/projects/DesistDaydream/dtcg/config_file:/etc/dtcg lchdzh/dtcg:v1.8.6
