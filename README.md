...
docker build . -t lchdzh/dtcg:v1.1.0 -f build/dtcg/Dockerfile
...
docker run -it --rm --name dtcg --network host -v ~/projects/DesistDaydream/dtcg/internal/database:/dtcg/internal/database lchdzh/dtcg:v1.1.0
